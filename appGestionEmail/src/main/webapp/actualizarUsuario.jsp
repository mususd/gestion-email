<%-- 
    ...
    - Envía cambios al servlet srvActualizarUsuario.
--%>
...
<html>
    ...
    <body>
        ...
        <div class="form-container">
            ...
            <form name="frmUsuario" action="srvActualizarUsuario" method="POST">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="txtIdEmpresa" value="<%=user1.getIdEmpresa()%>">
                </div>
                
                <div class="input-group mb-3">
                    <span class="input-group-text">Nombre</span>
                    <input type="text" class="form-control" name="txtNombre" value="<%=user1.getNombre()%>">
                </div>
                
                <div class="input-group mb-3">
                    <span class="input-group-text">Apellido</span>
                    <input type="text" class="form-control" name="txtApellido" value="<%=user1.getApellido()%>">
                </div>
                
                <div class="input-group mb-3">
                    <span class="input-group-text">Email</span>
                    <input type="text" class="form-control" name="txtEmail" value="<%=user1.getEmail()%>">
                </div>

                <div class="input-group mb-3">
                    <span class="input-group-text">Contraseña</span>
                    <input type="password" class="form-control" id="txtContrasena" name="txtContrasena" value="<%=user1.getContrasena()%>">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="date" class="form-control" name="txtFechaRegistro" value="<%=user1.getFechaRegistro()%>">
                </div>
        ...
        %>
                    <script> swal("Error", "No se pudo actualizar el usuario", "error"); </script>
        <%
                }
            }
        %>
