    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //Tipo de respuesta que necesitamos, 
            ...
            try{
                ...
                PdfPCell celda1 = new PdfPCell(new Paragraph("idEstadoEmail", FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
                PdfPCell celda2 = new PdfPCell(new Paragraph("nombreEstado", FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));               
