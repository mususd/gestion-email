 ...
 * generated in the Modelo.usuario package. 
...
public class ObjectFactory {
    ...
    private final static QName _Autenticar_QNAME = new QName("http://wsServicios/", "autenticar");
    private final static QName _AutenticarResponse_QNAME = new QName("http://wsServicios/", "autenticarResponse");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: Modelo.usuario
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://wsServicios/", name = "autenticar")
     ...
     */
    @XmlElementDecl(namespace = "http://wsServicios/", name = "autenticarResponse")
