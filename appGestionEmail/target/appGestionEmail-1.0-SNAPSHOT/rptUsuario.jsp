...
<html>
    ...
    <body>
        ...
        ============================== --%>
        <form name="frmReportes" action="srvPdfUsuario" method="POST">
            <div class="row d-flex justify-content-center">
                <div class="col-md-3">
                    <table class="table">
                        <thead>
                                <h5>Visor de Datos - Usuarios</h5>
                        </thead>
                        <tbody>
                            <tr>
                                <th scope="row">Usuario</th>
                                <td><input type="text" name="txtUsuario" value="" /></td>
                                <td><button type="submit" class="btn btn-dark" name="btnBuscarUsuario">Buscar</button></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
        ...
        ==================================================== --%>
        <form name="frmReportes2" action="srvPdfUsuario" method="POST">
            <div class="row d-flex justify-content-center">
                <div class="col-md-3">
                    <table class="table">
                        <thead>
